...
HD_PWD='D:/CESE/4B2025/FPGA - Circuitos Lgicos Programables/Codigos/sum2b/Sintesis/sum2b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sum2b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sum2b.tcl -notrace

...
HD_PWD='D:/CESE/4B2025/FPGA - Circuitos Lgicos Programables/Codigos/sum2b/Sintesis/sum2b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum2b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sum2b.tcl
